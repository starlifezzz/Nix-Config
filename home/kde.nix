...

{
  ...
  # ═══════════════════════════════════════════════════════════
  # 注意：此配置文件仅在不存在时才创建，避免覆盖用户的手动设置
  # xdg.configFile."plasma-org.kde.plasma.desktop-appletsrc" = 
  #   lib.mkIf (! builtins.pathExists "${config.home.homeDirectory}/.config/plasma-org.kde.plasma.desktop-appletsrc") {
  #     text = ''
  #       [ActionPlugins][0]
  ...
  #       launchers=applications:systemsettings.desktop,preferred://filemanager,preferred://browser,file:///var/lib/flatpak/exports/share/applications/com.qq.QQ.desktop,file:///var/lib/flatpak/exports/share/applications/com.tencent.WeChat.desktop,file://${pkgs.clash-verge-rev}/share/applications/clash-verge.desktop
