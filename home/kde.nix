...

{
  ...
  xdg.configFile."kdeglobals" = {
    text = ''
      ...
      DecorationFocus=85,173,223
      DecorationHover=85,173,223
      ForegroundActive=85,173,223
      ForegroundInactive=114,125,136
      ForegroundLink=60,128,176
      ForegroundNegative=207,82,91
      ForegroundNeutral=234,125,55
      ForegroundNormal=35,38,40
      ForegroundPositive=69,170,105
      ForegroundVisited=150,95,173
  ...
  # KWin Wayland 输入法配置   kwinrc - 窗口管理器配置
  ...
  xdg.configFile."kglobalshortcutsrc" = {
    text = ''
      ...
      Switch keyboard layout to English (US)=none,none,切换键盘布局为 English (US)
      ...
      Walk Through Windows=Meta+Tab\tAlt+Tab,Meta+Tab\tAlt+Tab,遍历窗口
      ...
      RectangularRegionScreenShot=Ctrl+Alt+A\tMeta+Shift+Print
    '';
    force = true;
  };

# ═══════════════════════════════════════════════════════════
  # plasma-org.kde.plasma.desktop-appletsrc - 面板和桌面配置
  # ═══════════════════════════════════════════════════════════
  xdg.configFile."plasma-org.kde.plasma.desktop-appletsrc" = {
    text = ''
      ...
      positions={"2560x1440":["1","23","desktop:/nixos","0","0"]}
      sortMode=-1

      [Containments][25][Wallpaper][org.kde.image][General]
      FillMode=1
      Image=file:///nix/store/hq4chr5m3fs3fqz3y13jjj7hnyj74prd-plasma-workspace-wallpapers-6.5.5/share/wallpapers/Mountain/
      SlidePaths=/nix/store/7985zb8h1r91v968b6wrzbq0457v19w7-breeze-6.5.5/share/wallpapers/,/run/current-system/sw/share/wallpapers/
      ...
      launchers=applications:systemsettings.desktop,preferred://filemanager,preferred://browser,file:///var/lib/flatpak/exports/share/applications/com.qq.QQ.desktop,file:///var/lib/flatpak/exports/share/applications/com.tencent.WeChat.desktop,file:////nix/store/l6a5jlnggl81rhkhj8dgk4shlr55l62w-clash-verge-rev-2.4.3/share/applications/clash-verge.desktop
      ...
      [Containments][26][Applets][31][Applets][33][Configuration]
      PreloadWeight=80
      ...
      [Containments][26][Applets][31][Applets][35][Configuration]
      PreloadWeight=95
      ...
      [Containments][26][Applets][31][Applets][36][Configuration]
      PreloadWeight=60
      ...
      [Containments][26][Applets][31][Applets][37][Configuration]
      PreloadWeight=100
      ...
      [Containments][26][Applets][31][Applets][38][Configuration]
      PreloadWeight=90
      ...
      [Containments][26][Applets][31][Applets][41][Configuration]
      PreloadWeight=70

      [Containments][26][Applets][31][Applets][41][Configuration][General]
      ...
      [Containments][26][Applets][31][Applets][42][Configuration]
      PreloadWeight=100

      [Containments][26][Applets][31][Applets][42][Configuration][General]
      migrated=true
      ...
      [Containments][26][Applets][31][Applets][46][Configuration]
      PreloadWeight=2
      ...
      [Containments][26][Applets][31][Applets][47][Configuration]
      PreloadWeight=2
      ...
      [Containments][26][Applets][31][Applets][48][Configuration]
      PreloadWeight=0
      ...
      screenMapping=desktop:/nixos,0,08acb5c3-defc-4df0-9aee-9016259f3dd6
    '';
    force = true;
  };
